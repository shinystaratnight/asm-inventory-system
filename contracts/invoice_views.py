...
class HallSalesInvoiceView(AdminLoginRequiredMixin, View):
    def post(self, *args, **kwargs):
        top_padding_height = int(256 * 0.4)
        cell_width_list = [ 256 *  10, int(256 * 11), int(256 * 12.5), int(256 * 3), 
                            int(256 * 6), int(256 * 10), int(256 * 8.5), int(256 * 9),
                            int(256 * 15), int(256 * 8.5), int(256 * 8.5)]

        cell_height = int(20 * 18)

        header_height = int(20 * 25.5)
        space_height = int(20 * 5.25)
        company_height = int(20 * 23.25)
        height_18 = int(20 * 18)
        height_16 = int(20 * 16)
        ...
        font_11_left = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert center, horiz left')
        font_11_right = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert center, horiz right')
        font_11_center_with_border = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert center, horiz center;\
                                                borders: top_color black, left_color black, right_color black, bottom_color black,\
                                                top thin, bottom thin, left thin, right thin;')
        font_11_left_with_border = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert center, horiz left;\
                                                borders: top_color black, left_color black, right_color black, bottom_color black,\
                                                top thin, bottom thin, left thin, right thin;')
        font_10_5_left = xlwt.easyxf('font: height 210, name ＭＳ Ｐゴシック; align: vert center, horiz left')
        ...
        payment_breakdown_style = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert top, horiz center;\
                                                borders: top_color black, left_color black, bottom_color black,\
                                                top medium, left medium, bottom medium')
        payment_first_cell_label_style = xlwt.easyxf('font: height 220, name ＭＳ Ｐゴシック; align: vert center, horiz center;\
                                                    borders: top_color black, left_color black, right_color black, bottom_color black,\
